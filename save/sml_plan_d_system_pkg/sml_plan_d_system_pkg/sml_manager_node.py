...
from sml_plan_d_msgs.action import NavTask, WbTask
from sml_plan_d_msgs.msg import Step, Task
from sml_plan_d_msgs.srv import ArmCommand, GetPlan
...
class SmlManagerNode(Node):
    ...
    def _execute_arm(self, step, retry=0):
        ...
        self.get_logger().info(
            ...
            f'location={req.location} | slide_ids={req.slide_ids}')
