...
class PlannerConfig:
    ...
    # Capacity hints. Recycle products are not configurable here: the competition
    # rule permits exactly one product in physical slot 1.
